...
public class Anonymous extends LocalCommunityObject implements
    Unidentifiable.PoliticalAffinity, java.io.Serializable {
  public int id;
  public boolean me = false;

  public Anonymous(String name, float x, float y, int id_) {

    this(false, name, x, y,id_);
  }

  public Anonymous(boolean me, String name, float x, float y, int id_) {
